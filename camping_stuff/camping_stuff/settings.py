"""
Django settings for Camping Stuff project.
...
ROOT_URLCONF = 'camping_stuff.urls'
...
WSGI_APPLICATION = 'camping_stuff.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'camping_stuff.db'),
    }
}
