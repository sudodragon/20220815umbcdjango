"""
Django settings for Simple Form Demo project.
...
WSGI_APPLICATION = 'djsimpform.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'djsimpform.db'),
    }
}
