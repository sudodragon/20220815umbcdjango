...
urlpatterns = [
    ...
    path('herox/<int:hero_num>/', views.hero_int, name="hero_int"),
    path('herox/<str:hero_text>/', views.hero_str, name="hero_str"),
    path('hero/<str:hero_name>/', views.hero, name="hero"),
  #  path('hero/<int:hero_num>/', views.hero, name="hero_num"),
