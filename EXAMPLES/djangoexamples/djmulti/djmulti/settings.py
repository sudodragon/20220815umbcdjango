"""
Django settings for Multiple Child Templates Demo project.
...
INSTALLED_APPS = [
    ...
    'multi_core.apps.MultiCoreConfig',
    # add your apps here:
...
WSGI_APPLICATION = 'djmulti.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'djmulti.db'),
    }
}
