"""
Django settings for Django US Presidents REST Api project.
...
INSTALLED_APPS = [
    ...
    'djpres_core.apps.DjpresCoreConfig',
    # add your apps here:
...
WSGI_APPLICATION = 'djpresapi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'djpresapi.db'),
    }
}
