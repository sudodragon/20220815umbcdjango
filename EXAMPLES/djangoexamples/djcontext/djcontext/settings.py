"""
Django settings for Django Context Processor Example project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'superheroes.context_processors.secret_word',
                'superheroes.context_processors.dump_request',
                'superheroes.context_processors.random_word',
            ],
        },
    },
]

WSGI_APPLICATION = 'djcontext.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'djcontext.db'),
    }
}
